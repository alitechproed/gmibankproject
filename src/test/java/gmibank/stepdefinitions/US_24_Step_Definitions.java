...
public class US_24_Step_Definitions {
    ...
    public int before_post_request_user_finds_out_the_size_of_the_state_list() {
        listOfStates = response.as(ArrayList.class);
    //    System.out.println("states: " + listOfStates.size());
        int listofSizefirst = listOfStates.size();
        return listofSizefirst;
    }
    ...
    public void user_sends_a_POST_request_to_REST_API_endpoint_as(String endpoint, String state) {
      ...
      //  System.out.println("lastStateId: " + idNumber);
    ...
    //    System.out.println(listOfStates.size());
        Assert.assertNotEquals("state olusturulmadi",listOfStates,before_post_request_user_finds_out_the_size_of_the_state_list());
