...
Feature: US_27 System should allow to delete states using api end point
  ...
  Scenario: TC_2701 before DELETE request
    Given I send a GET request to REST API end point  "https://www.gmibank.com/api/tp-states/1801"
  ...
  Scenario: TC_2702 check DELETE request
    Given I send a DELETE request to REST API end point  "https://www.gmibank.com/api/tp-states/1801"
