...
Feature: US_01 succes register with valid credentials
  ...
  @TC_003
  Scenario: TC_002  gecerli first name positive test
  ...
  @TC_004
  Scenario: TC_003 bos first name negative test
  ...
  @TC_005
  Scenario: TC_004  gecerli last name positive test
  ...
  @TC_006
  Scenario: TC_005 bos last name negative test
  ...
  @TC_007
  Scenario: TC_006  gecerli address test
  ...
  @TC_008
  Scenario: TC_007 gecerli mobile phone number test
  ...
  @TC_009
  Scenario: TC_008 gecersiz mobile phone number negative test
  ...
  @TC_010
  Scenario: TC_009 gecerli kullanici adi test
  ...
  @TC_011
  Scenario: TC_010 gecersiz kullanici adi test
  ...
  @TC_012
  Scenario: TC_011 gecerli email test
  ...
  @TC_013
  Scenario: TC_012 gecerli verilerle hesap olusturma
    Given Kullanici bir user olarak SSN textboxina "333-22-4444" numarasini girer
    ...
    And Kullanici bir user olarak Username textboxina  "Abc123" kullanici adini girer
    And Kullanici bir user olarak Email textboxina "abc@mail.com" mail adresini girer
