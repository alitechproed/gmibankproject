@US_29 @SmokeTest
Feature: US_27 validate all data from database

  Background: US_029 step background
    Given user  connecting GMI database

  @TC_2901
  Scenario: TC_2901 All users info should be retrieved by database and validated
