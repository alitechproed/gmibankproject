...
formatter.step({
  "name": "verify seventh customers \"ssn\" is \"888-88-8888\" and \"state\" is \"New Jersey\"",
  "keyword": "And "
});
formatter.match({
...
formatter.result({
  "error_message": "org.junit.ComparisonFailure: expected:\u003c[321-54-9800]\u003e but was:\u003c[888-88-8888]\u003e\r\n\tat org.junit.Assert.assertEquals(Assert.java:117)\r\n\tat org.junit.Assert.assertEquals(Assert.java:146)\r\n\tat gmibank.stepdefinitions.US_20_Step_Definitions.verifySeventhCustomersIsAndIs(US_20_Step_Definitions.java:60)\r\n\tat ✽.verify seventh customers \"ssn\" is \"888-88-8888\" and \"state\" is \"New Jersey\"(file:///C:/Users/HP%20Pavilion/IdeaProjects/gmibankproject/src/test/resources/features/us_20.feature:12)\r\n",
  "status": "failed"
});
formatter.background({
  "name": "TC_2001 and TC_2002 background",
...
formatter.step({
  "name": "verify first customer\u0027s \"firstName\" \"emre\"",
  "keyword": "And "
});
formatter.match({
...
formatter.result({
  "error_message": "org.junit.ComparisonFailure: expected:\u003c[John]\u003e but was:\u003c[emre]\u003e\r\n\tat org.junit.Assert.assertEquals(Assert.java:117)\r\n\tat org.junit.Assert.assertEquals(Assert.java:146)\r\n\tat gmibank.stepdefinitions.US_20_Step_Definitions.verifyFirstCustomerS(US_20_Step_Definitions.java:70)\r\n\tat ✽.verify first customer\u0027s \"firstName\" \"emre\"(file:///C:/Users/HP%20Pavilion/IdeaProjects/gmibankproject/src/test/resources/features/us_20.feature:17)\r\n",
  "status": "failed"
});
formatter.step({
  "name": "verify second customer\u0027s \"lastName\" \"John\"",
  "keyword": "And "
});
formatter.match({
...
formatter.step({
  "name": "verify fifth customer\u0027s country \"GERMANY\"",
  "keyword": "And "
});
formatter.match({
...
formatter.feature({
  "name": "system should allow to read all Applicants using api end point",
  "description": "",
  "keyword": "Feature",
  "tags": [
    {
...
formatter.step({
  "name": "find out 807 applicants are and verify",
  "keyword": "And "
});
formatter.match({
...
formatter.result({
  "error_message": "java.lang.AssertionError: expected:\u003c829\u003e but was:\u003c807\u003e\r\n\tat org.junit.Assert.fail(Assert.java:89)\r\n\tat org.junit.Assert.failNotEquals(Assert.java:835)\r\n\tat org.junit.Assert.assertEquals(Assert.java:647)\r\n\tat org.junit.Assert.assertEquals(Assert.java:633)\r\n\tat gmibank.stepdefinitions.US_23_Step_Definitions.findOutApplicantsAreAndVerify(US_23_Step_Definitions.java:57)\r\n\tat ✽.find out 807 applicants are and verify(file:///C:/Users/HP%20Pavilion/IdeaProjects/gmibankproject/src/test/resources/features/us_23.feature:11)\r\n",
  "status": "failed"
});
formatter.step({
...
formatter.feature({
  "name": "System should allow to create new states using api endpoint",
  "description": "",
  "keyword": "Feature",
  "tags": [
    {
...
formatter.step({
  "name": "User send a POST request to REST API endpoint \"https://www.gmibank.com/api/tp-countries/\" as \"Scottland\"",
  "keyword": "Then "
});
formatter.match({
...
formatter.step({
  "name": "After creation user verifies the created country \"Scottland\"",
  "keyword": "And "
});
formatter.match({
